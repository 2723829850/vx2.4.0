...
public class WechatConfig {
    ...
    static {
        userList.add(getUser(
                "oiJVP5mZKyyxpPRt2WTn9i3vdP1w", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "TWIge5TTvayrPGRSWGgz67Kok2IsHbXZt-oLWEdXQfg", //要给这个人发送的模板ID
                "宝贝", //咋称呼这个人
                "江苏省徐州市睢宁县", //这个人的详细地址
                "徐州", //这个人在的城市
                new BirthDay(2002,1,2,true,false,"pt生日快乐！！"),
                new BirthDay(1999,8,11,false,false,"生日快乐哦~~"),
                new BirthDay(2020,7,8,true,true),
                new BirthDay(2022,10,3,true,false,"周年快乐！！！")
        ));
